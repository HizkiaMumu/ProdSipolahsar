...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__detail_produk_detail_produk__ = __webpack_require__(104);
...
var JenisUkmPage = (function () {
    ...
    JenisUkmPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-jenis-ukm',template:/*ion-inline-start:"D:\project\sipolahsar_v1-master\src\pages\jenis-ukm\jenis-ukm.html"*/'<!-- HEADER -->\n<ion-header>\n  <ion-navbar color="darkBlue" no-padding>\n    <ion-grid>\n      <ion-row>\n        <ion-col col-2 *ngIf="!isSearchBarOpened" style="margin:auto;" no-padding>\n          <ion-buttons start>\n            <button ion-button icon-only (click)="back()">\n                <ion-icon name="ios-arrow-back"></ion-icon>\n            </button>\n          </ion-buttons>\n        </ion-col>\n        <ion-col col-8 *ngIf="!isSearchBarOpened" no-padding>\n          <ion-title style="font-size: 24px; text-transform: none;">\n            <p class="text-toolbar">\n              {{ item.key }}\n            </p>\n          </ion-title>\n        </ion-col>\n        <ion-searchbar *ngIf="isSearchBarOpened" showCancelButton="true" (search)="onSearch($event)" (ionCancel)="isSearchBarOpened=false"></ion-searchbar>\n        <ion-buttons>\n          <button ion-button icon-only class="ion-icon-close-searchbar" *ngIf="isSearchBarOpened" (click)=\'doRefreshButton($event)\'>\n            <ion-icon name="close"></ion-icon>\n          </button>\n        </ion-buttons>        \n        <ion-col col-2 *ngIf="!isSearchBarOpened" style="margin: auto; text-align: center;" no-padding>\n          <ion-buttons end>\n              <button *ngIf="!isSearchBarOpened" (click)="isSearchBarOpened=true" style="border:0px; background: none;">\n                <ion-icon class="icon-button" name="md-search" style="font-size: 15px;"></ion-icon>\n              </button>\n          </ion-buttons>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n  </ion-navbar>\n</ion-header>\n\n<!-- BODY -->\n<ion-content>\n    <ion-refresher (ionRefresh)="doRefresh($event)">\n        <ion-refresher-content\n          pullingIcon="arrow-dropdown"\n          pullingText="Tarik untuk menyegarkan"\n          refreshingSpinner="circles"\n          refreshingText="Menyegarkan...">\n        </ion-refresher-content>\n      </ion-refresher>\n  <img src="{{ item.foto }}" width="50%" height="auto" class="image">\n\n  <hr style="color: #dedede; margin-bottom: 1px !important;">\n\n  <ion-list>\n    <button ion-item *ngFor="let item of this.item?.data; let i = index" (click)="this.itemTapped(item)">\n      <ion-avatar item-start style="margin-top: 0px;">\n        <img style="border-radius: 100%;" src="assets/icon/item 1.svg" alt="" width="25px">\n      </ion-avatar>\n      <h2>\n        <b>{{ item.brand }}</b>\n      </h2>\n      <p>{{ item.nama_lengkap }}</p>\n      <ion-icon ios="ios-arrow-forward" md="ios-arrow-forward" item-end></ion-icon>\n    </button>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"D:\project\sipolahsar_v1-master\src\pages\jenis-ukm\jenis-ukm.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* ModalController */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__opening_satu_opening_satu__ = __webpack_require__(108);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoadingPage = (function () {
    ...
    LoadingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-loading',template:/*ion-inline-start:"D:\project\sipolahsar_v1-master\src\pages\loading\loading.html"*/'<!-- BODY -->\n<ion-content padding style="background-color: rgb(6, 0, 91);">\n  <img src="assets/imgs/Logo/logo sipolahsar logo wht.png" class="image">\n  <img src="assets/icon/Spinner-0.5s-200px.gif" class="loading">\n</ion-content>'/*ion-inline-end:"D:\project\sipolahsar_v1-master\src\pages\loading\loading.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
    ], LoadingPage);
    return LoadingPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__jenis_produk_jenis_produk__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__jenis_ukm_jenis_ukm__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__loading_loading__ = __webpack_require__(107);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SplashPage = (function () {
    ...
    SplashPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-splash',template:/*ion-inline-start:"D:\project\sipolahsar_v1-master\src\pages\splash\splash.html"*/'<!-- HEADER -->\n<ion-header></ion-header>\n\n<!-- BODY -->\n<ion-content padding>\n  <img src="assets/imgs/Logo/logo.png" width="90%" height="50%" class="logo_sipolahsar">\n  <button class="button" (click)="this.button()">Get Started</button>\n</ion-content>\n'/*ion-inline-end:"D:\project\sipolahsar_v1-master\src\pages\splash\splash.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_loading_loading__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_opening_satu_opening_satu__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_jenis_produk_jenis_produk__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_jenis_ukm_jenis_ukm__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_profil_profil__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_detail_produk_detail_produk__ = __webpack_require__(104);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\project\sipolahsar_v1-master\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"D:\project\sipolahsar_v1-master\src\app\app.html"*/
        }),
