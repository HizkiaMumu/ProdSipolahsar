...
import { DetailUkmPage } from '../detail-ukm/detail-ukm';
...
@IonicPage()
@Component({
  selector: 'page-jenis-ukm',
  templateUrl: 'jenis-ukm.html',
})
export class JenisUkmPage {
  item: any;
  data: any;
  keys: any;
  dataProduk: any;
  ...
  itemTapped(item){
    this.navCtrl.push(DetailUkmPage, item);
  }
